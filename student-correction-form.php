            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card card-info">
                    <div class="card-header ">
                        ...
                        <span class="mr-2"> <button class="btn btn-success btn-sm "  style="" data-toggle="tooltip" > <span class="badge" id="Accepted"> </span> Verified</button> </span>
    ...
    var code = 21;
        $.ajax({
            ...
            success: function(response) {
                ...
                document.getElementById("Accepted").textContent = data[2];
...
function Verifiedbutton(id,IDNo)
 {
