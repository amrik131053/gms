...
$pdf->SetXY(10,18);
$pdf->multicell(190, 5,"PROVISIONAL ADMIT CARD FOR ($examinationss) EXAMINATION",0,'C');
...
$pdf->SetXY(90,31);
$pdf->MultiCell(90, 6, "Course :    ".$course, 1, 'l');

$pdf->MultiCell(80, 6, "Semester :    ".$SemesterId." (".$type.")", 1, 'l');
$pdf->SetXY(90,37);
$pdf->MultiCell(90, 6, "Batch :    ".$batch, 1, 'l');
// $pdf->SetXY(10,43);
...
$pdf->SetXY(20,60);
$pdf->multicell(120, 6,"Subject/Subject Code",1,'C');
$pdf->SetXY(140,60);
$pdf->multicell(10, 6,"Ext",1,'C');
$pdf->SetXY(150,60);
$pdf->multicell(10, 6,"T/P",1,'C');
$pdf->SetXY(160,60);
$pdf->multicell(40, 6,"Sign. of Invigilator",1,'C');
...
while($row7 = sqlsrv_fetch_array($list_resultamrik, SQLSRV_FETCH_ASSOC) )
{
    ...
    $pdf->SetXY(20,$y);
    $pdf->multicell(120, 5,$row7['SubjectName'].'('.$row7['SubjectCode'].')',1,'C');
    $pdf->SetXY(140,$y);
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->multicell(190, 6,"Library",0,'L');

$pdf->SetXY(90,$YBottom+2);
$pdf->SetFont('Arial', 'B', 10);
$pdf->multicell(190, 6,"Dean",0,'L');
$pdf->SetXY(10,$YBottom+6);
$pdf->SetFont('Arial', '', 8);
// $pdf->multicell(190, 6,$DepartmentVerifiedDate,0,'L');
$pdf->SetXY(10,$YBottom+2);
$pdf->SetFont('Arial', 'B', 10);
$pdf-> Image('dist\img\examcontrollor.png',160,$YBottom-10,40,15);
$pdf->multicell(190, 5,"Controller of Examination",0,'R');
$pdf->SetXY(10,$YBottom+6);
$pdf->SetFont('Arial', '', 8);
