...
$ms1="<strike>Mr.</strike>";    // code...
 ...
 ?>
         ...
         <!-- // space -->
         <div>
            <div class="col-lg-12 " style="border:; font-size: 19px; margin-right: 80px;margin-left: 70px; color:#0E345C;">
               <p><b><?php  echo "CONTROLLER OF EXAMINATIONS";?></b>
                  <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo "REGISTRAR";?></b>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <b><?php  echo "PRO VICE CHANCELLOR";?></b>
               </p>
            </div>
         </div>
         <span style="border: ; z-index: 5;
            position: absolute;
            width: 150px;
            height: 20px;
            /*  font-weight: 500px;*/
...
$ms1="<strike>Mr.</strike>";    // code...
 ...
 ?>
         ...
         <span style="border: ; z-index: 5;
            ...
            height: 20px;
            /*  font-weight: 500px;*/
            top: <?=$margin_date=$margin_date-5;?>px;
            left: 170px;">
         <?php echo date('jS F Y'); ?></span>
      </span><?php 
