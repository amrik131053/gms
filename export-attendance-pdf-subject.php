...
FROM ExamForm INNER JOIN Admissions ON ExamForm.IDNo = Admissions.IDNo where  ExamForm.CourseID='$Course'AND ExamForm.Batch='$Batch' AND ExamForm.Type='$Type'   ANd ExamForm.SemesterID='$Semester' ANd ExamForm.Examination='$Examination' ANd ExamForm.Status='8' AND  Admissions.Status='1' ORDER BY Admissions.UniRollNo";
        $j=100;
