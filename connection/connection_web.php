...
$conn_recruitment= new mysqli('119.18.54.49:3306', 'guruk2cy_connect','Amrik@123','guruk2cy_recruitment');
 ...
 $conn_online_pre_regist= new mysqli('82.25.122.83:3306', 'u758234764_prepmguri','Gurpreet@pnm12','u758234764_pre_reg');
...
// $conn_online= new mysqli($servername1, $username1,$password1,'guruk2cy_online');
