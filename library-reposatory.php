                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="IDNo" id="IDNo" class="form-control" onkeyup="" value="0" hidden>

                                </div>
  <div class="col-lg-12">
                                    <label for="inputEmail3" class=" col-form-label">Name Of Researcher</label>
                                    <input type="text" id="pprAuth" name="pprAuth" required class="form-control">
                                </div>
                                <div class="col-lg-12">
                                    <label for="inputEmail3" class=" col-form-label">Topic</label>
...
?>
                                ...
                                <div class="col-lg-12">
                                    <label for="inputEmail3" class=" col-form-label">Name of Supervisor </label>
                                    <input type="text" name="pprJournal" required class="form-control">
                                </div>

                                <div class="col-lg-12">
                                    <label for="inputEmail3" class=" col-form-label">Year of Completed</label>
