              ...
              Search
                ...
                <?php 
                    ...
                    <div class="btn-group w-100 mb-2">
                        ...
                        <a class="btn btn-sm" id="btn6" style="background-color:#223260; color: white; border: 1px solid;"
                            onclick="window.location.reload();bg(this.id);"> Upload </a>
                        <a class="btn btn-sm" id="btn1" style="background-color:#223260; color: white; border: 1px solid;"
                            onclick="Add();bg(this.id);"> Add </a>


                        <a class="btn btn-sm" id="btn2" style="background-color:#223260; color: white; border: 1px solid;"
                        ...
                        ?>
                              ...
                              for($i=2011;$i<=2030;$i++)
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <input type="file" name="file_exl" id="file_exl" class="form-control form-control-sm" name=""
                                        required>
                                </div>
                                ...
                                <div class="col-lg-1">
                                    ...
                                    <input type="submit" name="" class="btn btn-success btn-sm" value="Upload">
                                </div>
                                <div class="col-lg-1">
                                    <label>Format</label><br>
                                    <button class="btn btn-warning btn-sm" type="button" onclick="format();">Download</button>
                                </div>
