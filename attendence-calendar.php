                ...
                <div class=" card card-primary">
                   <!--close2501  <div class="btn-group w-100 mb-2">
                        ...
                        <a class="btn btn-primary" id="btn2"
                            style="background-color:#223260; color: white; border: 5px solid;"
                            onclick="approvedLeaves(),bg(this.id);"> Approved </a>
...
<div class="modal fade" id="viewApprovedLeaveByAuth" tabindex="-1" role="dialog"
    aria-labelledby="viewApprovedLeaveByAuthLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
