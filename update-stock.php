            ...
            <div class="col-lg-12 col-sm-3 col-md-12">
                <div class="card card-info">
                        ...
                        <div class="col-lg-2">
                            <div class="input-group input-group-sm">
                                <button class="btn btn-outline-light btn-sm" data-toggle="modal"
                                    onclick="scanArticle();" data-target="#scan_article_modal" type="button"
                                    id="button-addon2">
                                    <i class="fa fa-qrcode"></i>
                                </button>
                                <input type="text" class="form-control" id='article_No' placeholder="Article No..."
                                    aria-describedby="button-addon2">
                                <button class="btn btn-info btn-sm" type="button" id="button-addon2"
                                    onclick="articleTask(0)">
                    ...
                    <div class="card-body table-responsive" id="stock_add">
                        <!-- Table or content will be dynamically loaded here -->
                    </div>
                </div>
            </div>
        </div>
...
<!-- Modal Definitions -->
<?php include "stock-update-modals.php"; ?>
