<div style="border-radius: 2px;border: 2px;border-style: solid;" >
   ...
   <div class="row">
      <table  class="table table-striped"  id="example">
         <tr>
            <th  style="min-width:auto;margin-left: 30px;text-align: left;">
               No:<b> <?php echo $request_no;?></b>
            </th>
            ...
            <th style="text-align: right;" >
               <img src='https://barcode.tec-it.com/barcode.ashx?data=<?php echo $reference_num;?>&code=Code11&multiplebarcodes=false&translate-esc=false&unit=Fit&dpi=96&imagetype=Gif&rotation=0&color=%23000000&bgcolor=%23ffffff&qunit=Mm&quiet=0' alt='Barcode ' width="150px" height="70px"/>
            </th>
         </tr>
         <tr>
            <th >
               <h6>College: <?php echo $college;?></h6>
            </th>
            <th style="text-align: center;"> </th>
            <th>
               <h6> Department: <?php echo $college_dept;?></h6>
            </th>
         </tr>
      </table>
   </div>
         ...
         <table class="table table-striped" id="example" >
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td style="width: 40px;text-align: center;"><?php echo $comments;?></td>
               </tr>
               <?php 
                  $i++;  }  
                  } 
