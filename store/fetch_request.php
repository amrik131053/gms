      ...
      {   $i=0;
          ?>  
                ...
                <input type="hidden" name="code" value="3"> 
                    ...
                    <td> <input type="hidden"  name="id[]" value="<?php echo $row["id"];?>"><?= $count;?></td>  
          ...
          <td>
           ...
           if($myrows>1)
           {
            if($request_status=='pending' OR $request_status=='recommending') 
       {?>
            <a href="#" onclick="delete_dr(<?php echo $row["id"];?>)"  class="fa fa-trash" data-target=".bs-delete-model-sm" data-toggle="tooltip" style="color:red"  data-placement="top" title="Delete"></a><?php }
          }
