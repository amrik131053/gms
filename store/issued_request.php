...
<div id='printrel'>
      ...
      <thead>
          ...
          <th style="width: 250px;text-align: center;">Article</th>
          <th>Specification</th>
                <th>Comments</th>
      ...
      { 
          ...
          ?>  
                ...
                <input type="hidden" name="code" value="3"> 
                    ...
                    <td style="width=15px;text-align: center;" > <input type="hidden"  name="id[]" value="<?php echo $row["id"];?>"><?= $i;?></td>  
                    <td   style="width: 150px;text-align: center;"><?php echo $row["category_name"];?></td>
              <td  style="width: 250px;text-align: center;"><?php echo $row["item_name"];?></td>
          <td  style="text-align: center;width: 200px;"><?php echo $row["specification"];?></td>
          <td  style="text-align: center;width: 200px;"><?php echo $comments;?></td>
            <td style="width: 40px;text-align: center;"><?php echo $row["quantity"];?></td>
             <td style="width: 40px;text-align: center;"><?php echo $row["varify_qty"];?></td>
               <td style="width: 40px;text-align: center;"><?php echo $row["approved_qty"];?></td>

                 <td style="width: 40px;text-align: center;"><?php echo $row["issued_qty"];?></td>
...
<br>
 <div class="row"> 
                          <table  class="table table-striped"  id="example"> <tr><td  style="min-width:auto;margin-left: 30px;text-align: left;">
                           Requested By:<b><br>
<?php echo $name ;?></b><br>
...
<?php  echo $r_date; ?></td> 
 ...
 <!--<td  style="text-align:left;"> Verified By:<b><br>
<?php echo $v_autho ;?></b><br>

<?php echo $v_designation ;?><br>

                     Guru Kashi University<br>
<?php  echo $v_date; ?></td>--><td style="text-align: left" >
                        Approved By:<b><br>
...
<?php  echo $a_date; ?>
  ...
  <p align="right"><button class="btn btn-info" id="printbtn" onclick="printdiv()">Print</button></p>
