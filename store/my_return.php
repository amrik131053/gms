...
$sql = '';
 ...
 $list_sql = "SELECT * FROM returned where emp_id='$emp_id' AND request_status='draft'  ORDER BY ID DESC ";
...
mysqli_fetch_array($result))  
      {   $i=0;
          ...
          <td>
            ...
            <a href="#" onclick="delete_dr('.$row['id'].')"  class="glyphicon glyphicon-remove-sign" data-target=".bs-delete-model-sm" data-toggle="tooltip"  data-placement="top" title="Delete"></a>
                  </td>
                </tr>  
           ';  
...
if(mysqli_num_rows($result) > 0)  
 { 
$output .='<input type="submit" class="btn btn-primary" value="Publish"><br/><hr>';
}
 $output .= '</form>
