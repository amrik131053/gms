...
<section class="content">
      ...
      <div class="col-lg-4 col-md-4 col-sm-3">
         <div class="card card-info">
            <div class="card-header ">
               <h3 class="card-title">Theory Examination</h3>   
            </div>
            <div class="card-body">
  ...
  <?php }?>
         ...
         <p id="sem_"></p>
                     ...
                     <div class="col-lg-12">
                        ...
                        <input type="button" onclick="open_examination_permision();" class="btn btn-warning" value="Update">
                     </div>
                  </div>
               </div>
            </div>
  ...
  <?php }?>
                ...
                <div class="col-lg-6">
               <input type="button" class="btn btn-secondary" onclick="open_examination_permision_search();" value="Search">
            </div>
         </div>
         </div>
            <!-- /.card-header -->
            <div class="card-body table-responsive  " id="table_load" style="height:;">
  ...
  // alert(exam_type);
     var code=223;
           $.ajax({
              ...
              type:'POST',
              data:{
                 code:code,id:id,sem:Semester,start_date_edit:start_date_edit,end_date_edit:end_date_edit
              },
         ...
         var end_date=document.getElementById('end_date').value;
          var id_array=document.getElementsByClassName('sel');
           ...
           $.ajax({
              ...
              type:'POST',
              data:{
                 code:code,id_array_main:id_array_main,exam_type:exam_type,start_date:start_date,end_date:end_date
              },
              success: function(response) 
              {
               console.log(response);
