        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-4 col-sm-3">
                <div class="card card-info">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                               <h3 class="card-title">Upload Questions</h3>
                                ...
                                &nbsp;
                                &nbsp;
                                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-lg"
                                        style="text-align:right;">Copy</button>
                    ...
                    <form id="image-upload" name="image-upload" class="form-horizontal" action="action.php"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-3">
                                    ...
                                    <select name="Course" id="Course" class="form-control"
                                        onchange="selectSubName(this.value); q_check_count(); total_count();">
                           ...
                           {
                              ?>
                                        <option value="<?=$questionTypeData['id']?>"><?=$questionTypeData['type_name']?>
                                        </option>
                                        <?php
                           }
                           ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <b style="color:red; font-family:Serif;">Note: Upload without Apostrophe ( ' )
                                        symbol</b>
            ...
            ?>
                        <div class="card-footer" style="text-align: right;">
                            <input type="button" value="Submit" class="btn btn-success" id="submitBtn"
                                onclick="submitForm(this.form);" disabled>
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <select name="College" id='Collegecopy' onchange="fetchcourse(this.value);" class="form-control"
                            required>
                  ...
                  $sql="SELECT DISTINCT MasterCourseCodes.CollegeName,MasterCourseCodes.CollegeID from MasterCourseCodes  INNER JOIN UserAccessLevel on  UserAccessLevel.CollegeID = MasterCourseCodes.CollegeID  where IDNo='$EmployeeID'";
                    ...
                    <div class="col-lg-6">
                        ...
                        <label>College Name</label>
                        <select name="College" id='Collegecopy1' onchange="fetchcourse1(this.value);"
                  ...
                  $sql="SELECT DISTINCT MasterCourseCodes.CollegeName,MasterCourseCodes.CollegeID from MasterCourseCodes  INNER JOIN UserAccessLevel on  UserAccessLevel.CollegeID = MasterCourseCodes.CollegeID where IDNo='$EmployeeID'";
                     ...
                     while($row1 = sqlsrv_fetch_array($stmt2, SQLSRV_FETCH_ASSOC))
                      {   
                        ...
                        <select id="Semestercopy1" name="semester" onchange="fetchcodesnew()" class="form-control"
                            required>
                            <option value="">Semester</option>
                            <?php 
                              for($i=1;$i<=12;$i++)
                        ...
                        <select id="Subjectcodecopy1" name="semester" onchange="checkvalidation(this.value)"
                            class="form-control" required>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-primary" id='save' onclick="copyquestions()"
...
function copyquestions() {
    ...
    if (College != '' && Course != '' && Batch != '' && Unit != '' && Semester != '' && SubjectCode != '' && College1 !=
        '' && Course1 != '' && Batch1 != '' && Semester1 != '' && SubjectCode1 != '') {
