      ...
      <div class="col-lg-8">
         <div class="card">
            ...
            <div class="card-body table-responsive " >
                ...
                <table class="table" id="example1" style="overflow-y:auto">
            <thead>
                <tr>
                    <th>Sr No</th><th>Article Name</th><th>Code</th><th>Quantity</th></tr>
...
$permission_qry="SELECT * FROM category_permissions cp  inner join master_calegories  mc on  mc.id=cp.CategoryCode where employee_id='$EmployeeID' order by mc.id Desc ";


   $permission_res=mysqli_query($conn,$permission_qry);
   while($permission_data=mysqli_fetch_array($permission_res))
   {
      $dep=$permission_data['CategoryName'];
   }
 $list_sql = "SELECT * FROM master_stock where category='$dep'";
      ...
      { 
{
 ...
 $stock_quantity2=$row["quantity"];
  $new_quantity1=$stock_quantity2 - $stock_quantity1;
}
