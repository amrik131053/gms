...
<section class="content">
                    ...
                    <div class="card-body table-responsive" id="lab_users_data">
                        ...
                        <table class="table  " id="example">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th><input type="checkbox" id="select_all1" onclick="verifiy_select();" class="">
                                    </th>
                                    <th>Image</th>
                                    <th>IDNo</th>
                                    <th>Name</th>
   ...
   $date=date('Y-m-d');
            ...
            ?>
                                <tr>
                                    <td colspan="13"> <button type="submit" id="type" onclick="verifyAll();"
                                            name="update" class="btn btn-success " style="float:right;">Check out
                                            all</button></td>
                                </tr>
                            </tbody>
                        </table>
