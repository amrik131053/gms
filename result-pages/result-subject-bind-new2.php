...
$list_cllegename = sqlsrv_query($conntest,$collegename);
 ...
 Batch='$Batch' AND SemesterID='$Semester' ANd Isverified='1' ANd (SubjectType like '%T%' OR SubjectType='M' OR SubjectType='S' OR SubjectType='S1' OR SubjectType='TP' OR SubjectType='P'OR SubjectType='W')  order by SubjectType";
