...
$_SESSION['RequiredData']=$alertMessage;
       ...
       $urls=array('Dashboard.php','not_found.php','bulk_assign.php','password-change.php','print.php','attendence-calendar.php','profile.php','staff-attendance.php','books-issued.php');
