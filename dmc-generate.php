                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <div class="row ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <span><i class="fa fa-stop text-success" aria-hidden="true"></i> Generated</span>
                        </div>&nbsp;
                        <div id="live_data">
...
function generateDMC() {
    var SrNoLatter = document.getElementById('SrNoLatter').value;
    var SrNoFrom = document.getElementById('SrNoFrom').value;
    var decDate = "";
    var Remakrs = document.getElementById('Remakrs').value;
    ...
    if ((typeof subjectIDs[0] == 'undefined')) {
        ...
        if (SrNoFrom != '' && SrNoLatter!='') {
            ...
            ErrorToast('Please enter SrNoFrom/declareDate ', 'bg-warning');
