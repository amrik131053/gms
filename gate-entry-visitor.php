         ...
         <div class="col-lg-12 col-md-12 col-sm-12" >
            ...
            <div class="card card-info collapsed-card" >
               <div class="card-header">
                  <h3 class="card-title">Gate Entry Form</h3>
               ...
               <div class="card-body " >
                  ...
                  <div class="row">
                    ...
                    <a class="btn" id="btn2" style="background-color:#223260; color: white; border: 1px solid;" onclick="Visitor();bg(this.id);"> Visitor </a>
                    <a class="btn" id="btn3" style="background-color:#223260; color: white; border: 1px solid;" onclick="passout();bg(this.id);"> PassOut </a>
                    <a class="btn"  id="btn4" style="background-color:#223260; color: white; border: 1px solid;" onclick="staff();bg(this.id);"> Staff </a>
               ...
               <div class="col-lg-10 col-md-10">
                  ...
                  <div class="row"  id="Visitor">
                     <div class="col-lg-3 col-md-3">
                        <label>Person/Department<span style="color: red">*</span></label>
                        <select class="form-control" id="pord" onchange="ShowHideDiv();" onclick="gatePassAvailable()" >
                           <option value=""> SELECT</option>
                           <option value="Person"> Person</option>
                           <option value="Department"> Department</option>
                        </select>
                     </div> 
                        <div class="col-lg-3 col-md-3" id="dvPassport" style="display:none">
                ...
                <div class="row" style="display: none;" id="PassOut" style="display:none">
                      <div class="col-lg-3 col-md-3">
...
<input type="text" name=""  class="form-control" value="" disabled>
      ...
      <div class="col-lg-3">
         <label>Phone</label><input type="text" name="" class="form-control" value="" disabled></div>
      <div class="col-lg-3">
<label>Batch</label>
         <input type="text" name="" class="form-control" value="" disabled></div>
      <div class="col-lg-6">
<label>College</label>
         <input type="text" name="" class="form-control" value="" disabled></div>
      <div class="col-lg-3 col-md-3" >
         ...
         <!-- </div> -->
               ...
               <div class="row" style="display: none;" id="Staff" style="display:none">
...
<script type="text/javascript">
   ...
   function gatePassAvailable(visitorId) 
   {
      // alert(visitorId);
      var code=157;
      $.ajax(
      {
         ...
         success:function(response)
         {
            document.getElementById("passno").innerHTML=response; 
