         ...
         <div class="card card-info">
            ...
            <div class="card-body table-responsive">
               <div class="form-group row">
                        <form id="submit_daily_report" action="action_g.php" method="post" enctype="multipart/form-data">
                     <div class="row">
            ...
            <b> <?=$row_staff['Name'];?></b>
             (<?=$show_daily_task_row['AssignBy'];?>)
               ...
               echo "<tr><td colspan='5'><center><small style='color:red;'>----------No Taks Found----------</small></center> <td> </tr>";?>
                            ...
                            <select class="form-control" name="change_status1[]" style="display: none;">
                ...
                if ($EmployeeType!='Regular')
                 {
                        ...
                        <div class="row Teaching box">
                            ...
                            <div class="col-lg-12"><br><br>
                                ...
                                <small style="color:red;"><center>Under Maintenance</center></small>
                            </div>
                        </div>
            <?php }  else{  ?>
               ...
               <label>Date</label>
                         ...
                         <input type="date" class="form-control" value="<?= date('Y-m-d');?>" id='date_r' name="date_r"   min='<?= $lastMonth = date("Y-m-d", strtotime("-4 day"));  ?>' max="<?= date('Y-m-d');?>">
                        </div>
                     
                        <div class="col-lg-12">
                            <label>Activity  Report <small style="color:red;">(Please do not write serial number just press enter for new line)</small></label>
                         <textarea class="form-control" id="BeforeNoon" name="BeforeNoon" required></textarea>
                        </div>
                        <div class="col-lg-12" style="display:none">
                            <label>Work Done After Noon<small style="color:red;">(Please do not write serial number just press enter for new line)</small></label>
...
<div id="dvPassport1" style="display: none">
    ...
    <input type="text"  class="form-control"  name="FutureVision" id="txtPassportNumber1" >
</div>
</div>
            ...
            <?= date('d-m-Y');?><br>
                           ...
                           <input type="submit" onclick="" class="btn btn-primary btn-xs" value="Submit"  >
                        </p>
                        </div>
                        </div>
