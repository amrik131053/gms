...
<section class="content">
                    ...
                    <form action="print-custom.php" method="post" target="_blank">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12">
                                    <select class="form-control" required="" name="Block_assign" id="Block_assign"
                                        onclick="block_assign();">
   ...
   ?>
                                    ...
                                    <select class="form-control" required="" name="Floor" id="Floor_assign"
                                        onclick="floor();">
                                        <option value="">Select</option>
                                    </select>
                                    ...
                                    <select class="form-control" required="" name="RoomType" id="RoomType"
                                        onclick="getid();">
                                        <option value="">Select</option>
                                    </select>
            ...
            <div class="col-lg-3 col-md-8 col-sm-3">
                <div class="card card-info">
                    ...
                    <form action="print-custom.php" method="post" target="_blank">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="inputEmail3" required="" class="col-sm-12 col-form-label">Category
                                    Name</label>
                                ...
                                <label for="inputEmail3" required="" class="col-sm-12 col-form-label">Article
                                    Name</label>
                                <div class="col-lg-12">
