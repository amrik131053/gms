...
<div class="modal fade" id="ForwardTaskModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="icheck-primary d-inline">
                            <input type="radio" id="radioPrimary3" name="forward1" onclick="forward_team_show();"
                                checked>
                ...
                <div class="row">
                 ...
                 while($dropdown_row_staff = sqlsrv_fetch_array($dropdown_team_run, SQLSRV_FETCH_ASSOC) )
                 {
                   ...
                   ?>
                        ...
                        <?php  //print_r($aaa);?>
                        <input type="text" class="form-control" placeholder="Emp ID" id="forward_other_div"
                            onkeyup="emp_detail_verify_for(this.value)" style="display: none;">
                 ...
                 while($dropdown_row_staff = sqlsrv_fetch_array($dropdown_team_run, SQLSRV_FETCH_ASSOC) )
                 {
                   ...
                   ?>
                        ...
                        <input type="text" class="form-control" placeholder="Emp ID"
                            onkeyup="emp_detail_verify(this.value)" id="other_div" style="display: none;">
                        <p id="emp_detail_status_"></p>
                        <input type="hidden" class="form-control" value="<?=$EmployeeID;?>" id="self_div"
                            style="display: none;">
                    </div>
                </div>
                <label>End Date</label>
...
<section class="content">
    ...
    <div class="card">
        ...
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="pill" href="#custom-tabs-one-home" role="tab"
                    aria-controls="custom-tabs-one-home" aria-selected="true" onclick="my_task();"><b>My Task</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="pill" href="#custom-tabs-one-profile" role="tab"
                    aria-controls="custom-tabs-one-profile" aria-selected="false" onclick="assign_task();"><b>Assign
                        Task</b></a>
            </li>
        </ul>
