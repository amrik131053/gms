                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mb-3 position-relative" style="display: inline-block;">
                                            ...
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal-view-upload-image"
                                                class="position-absolute"
                                                style="top: 0%; left: 100%; transform: translate(-50%, -50%); background: #223260; border-radius: 20%; padding: 2px;">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <g id="SVGRepo_iconCarrier">
                                                        <path
                                                            ...
                                                            stroke="#f8f7f7" stroke-width="1.5" stroke-linecap="round"
                                        ...
                                        <div class="mb-3 position-relative" style="display: inline-block;">
                                            <span class="avatar avatar-xl rounded"
                                                style="background-image: url('{{ isset($profileData['SignaturePath']) ? 'http://erp.gku.ac.in:86/Images/Signature/'.$profileData['SignaturePath'] : 'default-image-url.jpg' }}');width:300px; height:100px;">


                                            </span>
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#modal-view-upload-signature" class="position-absolute"
                                                style="top: 0%; left: 100%; transform: translate(-50%, -50%); background: #223260; border-radius: 20%; padding: 2px;">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="father_name"
                                                                    name="father_name"
                                                                    value="{{$profileData['FatherName']}}" disabled>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="mother_name"
                                                                    name="mother_name"
                                                                    value="{{$profileData['MotherName']}}" disabled>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="dob"
                                                                    name="dob"
                                                                    value="{{ \Carbon\Carbon::parse($profileData['DOB'])->format('d-m-Y') }}"
                                                                    disabled>
                                                            </div>

                                                            <div class="col-md-3 mb-3">
                                                                <label for="bloodgroup" class="form-label">Blood
                                                                    Group</label>
                                                                <select id="bloodgroup" name="bloodgroup"
                                                                    class="form-select">
                                                                    <option value="{{$profileData['BloodGroup']}}">
                                                                        {{$profileData['BloodGroup']}}</option>
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                ...
                                                                $profileData['ABCID']!=NULL )
                                                                <div class="input-icon mb-3">
                                                                    <input type="text" class="form-control" id="abcid"
                                                                        name="abcid" value="{{$profileData['ABCID']}}"
                                                                        readonly>
                                                                    <!-- <input type="text" value="" class="form-control" placeholder="Search…"> -->
                                                                    <span class="input-icon-addon">
                                                                        <svg fill="#f40101" class="icon" width="24"
                                                                            height="24" version="1.1" id="Layer_1"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                <div class="input-icon mb-3">
                                                                    ...
                                                                    <!-- <input type="text" value="" class="form-control" placeholder="Search…"> -->
                                                                    <span class="input-icon-addon">
                                                                        <svg fill="#1a9509" class="icon" width="24"
                                                                            height="24" version="1.1" id="Layer_1"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            viewBox="0 0 330 330" xml:space="preserve">
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                <label for="otr" class="form-label">OTR <small
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <input type="email" class="form-control" id="email"
                                                                    name="email" value="{{$profileData['EmailID']}}"
                                                                    required>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="mobile"
                                                                    name="mobile"
                                                                    value="{{$profileData['StudentMobileNo']}}"
                                                                    required>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="course"
                                                                    name="course" value="{{$profileData['Course']}}"
                                                                    disabled>
                                                            </div>

                                                            <!-- Class Roll No -->
                                                            <div class="col-md-6 mb-3">
                                                                <label for="class_roll_no" class="form-label">Class Roll
                                                                    No</label>
                                                                <input type="text" class="form-control"
                                                                    id="class_roll_no" name="class_roll_no"
                                                                    value="{{$profileData['ClassRollNo']}}" disabled>
                                                            </div>

                                                            <!-- Uni Roll No -->
                                                            <div class="col-md-6 mb-3">
                                                                <label for="uni_roll_no" class="form-label">Uni Roll
                                                                    No</label>
                                                                <input type="text" class="form-control" id="uni_roll_no"
                                                                    name="uni_roll_no"
                                                                    value="{{$profileData['UniRollNo']}}" disabled>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="idno"
                                                                    name="idno" value="{{$profileData['IDNo']}}"
                                                                    disabled>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="batch"
                                                                    name="batch" value="{{$profileData['Batch']}}"
                                                                    disabled>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="college"
                                                                    name="college"
                                                                    value="{{$profileData['CollegeName']}}" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
