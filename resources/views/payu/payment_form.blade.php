        ...
        <div class="row row-cards">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="fee_type" class="form-select" id="fee_type" required>
                                ...
                                <option value="{{ $dropDownHeadValue['Head'] }}">{{ $dropDownHeadValue['Head'] }}
                                </option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="col-lg-7 col-sm-12">
                <form action="" method="post" class="card">
                    ...
                    <div class="card-body">
                        <b class="text-danger">Important:</b> <small class="text-danger">If you see that the payment
                            amount has been deducted from your bank account but you have not received your receipt,
                            don’t worry. Click the Sync button below to synchronize your transaction and generate your
                            receipt.<br></small>
                        <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-tbody">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($recent['Paymentdate'])->format('d-m-Y') }}
                                            </td>
                                            <td>{{ $recent['Amount'] }}</td>
